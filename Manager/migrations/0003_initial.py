    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses', models.ManyToManyField(null=True, related_name='students', to='Manager.course')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
        ...
        migrations.AddField(
            model_name='test',
            name='tutorial',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Manager.tutorial'),
        ),
        migrations.CreateModel(
            name='Questions',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('pdf', 'PDF'), ('docs', 'Word'), ('ppt', 'PPT')], max_length=100)),
